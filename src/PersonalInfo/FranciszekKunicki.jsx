...
const FranciszekKunicki = () => {
	return (
		<div className = 'info'>
			Tata urodził się w miejscowości Powiazyń (powiat Radoszkowice) na terenie
			obecnej Białorusi. Tam spędził dzieciństwo i młodość. W roku 1944 wstąpił
			do tworzącej się II Armii LWP. Został wcielony do 17 PP wchodzącego w
			skład 4DP. Ze swoim pułkiem przeszedł cały szlak bojowy jednostki. Brał
...
export default FranciszekKunicki;
